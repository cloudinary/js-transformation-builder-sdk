...
describe("resize.toJson()", () => {
  it("scale", () => {
    const transformation = new Transformation().addAction(Resize.scale(200));
  ...
  it("should generate auto gravity model", () => {
    const transformation = new Transformation().addAction(
      Resize.fill()
        .width(100)
        .height(100)
        .gravity(autoGravity().autoFocus(AutoFocus.focusOn(face())))
    );
  ...
  it("should generate an AutoBackgroundModel", () => {
    const transformation = new Transformation().addAction(Resize.pad(200).background(Background.auto()));
  ...
  it("should generate a BlurredBackgroundModel", () => {
    const transformation = new Transformation().addAction(
      Resize.pad(200).background(Background.blurred().intensity(10).brightness(20))
    );
  ...
  it("should generate a BorderBackgroundModel", () => {
    const transformation = new Transformation().addAction(
      Resize.pad(200).background(Background.border().contrast().palette("RED", "GREEN", "BLUE"))
    );
  ...
  it("should generate a PredominantBackgroundModel", () => {
    const transformation = new Transformation().addAction(
      Resize.pad(200).background(Background.predominant().contrast().palette("RED", "GREEN", "BLUE"))
    );
  ...
  it("should generate a ColorBackgroundModel", () => {
    const transformation = new Transformation().addAction(Resize.pad(200).background(Background.color("red")));
