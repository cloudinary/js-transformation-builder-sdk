...
describe("Tests for Transformation Action -- NamedTransformation", () => {
  it("Works with wasm", () => {
    const tx = new Transformation().customFunction(CustomFunction.wasm("my/example.wasm")).toString();
  ...
  it("Works with remote", () => {
    const tx = new Transformation()
      .customFunction(CustomFunction.remote("https://my.preprocess.custom/function"))
      .toString();
  ...
  it("Works with remote preprocessed", () => {
    const tx = new Transformation()
      .customFunction(CustomFunction.remote("https://my.preprocess.custom/function").preprocess())
      .toString();
