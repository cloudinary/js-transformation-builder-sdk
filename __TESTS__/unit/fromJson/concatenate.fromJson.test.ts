...
describe("concatenate.fromJson", () => {
  ...
  it("Should generate ConcatenateAction with transition from model", () => {
    ...
    expect(transformation.toString()).toStrictEqual(
      "du_1,l_video:dog/ar_7.0,c_scale,w_100/e_transition,l_video:cat/fl_layer_apply/fl_layer_apply,so_0"
    );
  });
  ...
  it("Should generate ConcatenateAction with ImageSource and transition from model", () => {
    ...
    expect(transformation.toString()).toStrictEqual(
      "du_1,l_dog/ar_7.0,c_scale,w_100/e_transition,l_video:cat/fl_layer_apply/fl_layer_apply,so_0"
    );
  });
  ...
  it("Should generate ConcatenateAction with FetchSource and transition from model", () => {
    ...
    expect(transformation.toString()).toStrictEqual(
      "du_1,l_fetch:aHR0cHM6Ly9leGFtcGxlLmNvbQ==.jpg/e_transition,l_video:cat/fl_layer_apply/fl_layer_apply,so_0"
    );
  });
});
