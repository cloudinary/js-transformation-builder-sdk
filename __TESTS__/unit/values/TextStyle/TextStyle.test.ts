...
describe("Text Style tests", () => {
  it("Create a new instance", () => {
    const res = new TextStyle("arial", 50).toString();
    expect(res).toBe("arial_50");
  });

  it("Create a new with italic", () => {
    const res = new TextStyle("arial", 50).fontStyle(FontStyle.italic()).toString();
  ...
  it("Create a new with all options", () => {
    const res = new TextStyle("arial", 50)
      ...
      .toString();
    expect(res).toBe(
      "arial_50_bold_italic_strikethrough_justify_stroke_letter_spacing_10_line_spacing_20_antialias_good_hinting_full"
    );
  });
  ...
  it("Create a new instance with stroke solid", () => {
    const res = new TextStyle("arial", 50).stroke(Stroke.solid(2, Color.WHITE)).toString();
