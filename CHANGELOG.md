...
- Add Displace action
- Fix Trim action imports
- Add internal utilities for Distort and Shear actions

1.20.0 / 2025-07-29
==================

- Add `functionType` property to Contrast

1.19.0 / 2025-07-29
==================

- Add fromJson support to Vibrance action.
...
* Add support for the `e_extract` action
