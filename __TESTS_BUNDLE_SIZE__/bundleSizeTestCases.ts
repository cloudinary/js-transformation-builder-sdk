...
const bundleSizeTestCases: ITestCase[] = [
  ...
  },
  {
    ...
    sizeLimitInKB: 45,
    importsArray: [importFromPackage("createCloudinaryLegacyURL")],
  },
  {
    name: "Import all of the SDK",
    sizeLimitInKB: 128,
    importsArray: [importFromPackage("* as CloudinaryURLGEN")],
  },
  {
    name: "Import a Transformation Object",
    sizeLimitInKB: 7,
    importsArray: [importFromPackage("Transformation")],
  },
  {
    name: "Import All Actions",
    sizeLimitInKB: 60,
    importsArray: [importFromPackage("Actions")],
  },
  {
    name: "Import All Qualifiers",
    sizeLimitInKB: 40,
    importsArray: [importFromPackage("Qualifiers")],
  },
];
