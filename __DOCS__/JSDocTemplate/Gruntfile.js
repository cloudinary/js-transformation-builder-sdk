module.exports = function (grunt) {
  ...
  grunt.initConfig({
      ...
      template: {
        files: [
          ...
          },
          {
            expand: true,
            flatten: true,
            src: ["src/utils/postProcessor.js"],
            dest: "template/utils/",
            filter: "isFile",
          },
          {
    ...
    uglify: {
      prism: {
        // prism requires it's own build as I've modified some plugins and use some default ones to.
        files: {
