    ...
    $("dt.collapsible-symbol")
      ...
      .on("click", function (e) {
        ...
        if (
          ...
          $target.is(".checkbox,.checkbox-inline") ||
          $target.closest(".checkbox,.checkbox-inline").length != 0
        )
          return;
